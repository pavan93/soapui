...
public interface WSISettings {
    String BASIC_PROFILE_10_TAD = "BasicSecurityProfile-1.0-TAD.xml";
    String BASICf_PROFILE_11_TAD = "BasicSecurityProfile-1.1-TAD.xml";

    String ENDPOINT_LOG_FILE_CORRELATION_TYPE = "endpoint";
    String NAMESPACE_LOG_FILE_CORRELATION_TYPE = "namespace";
    String OPERATION_LOG_FILE_CORRELATION_TYPE = "operation";

    @Setting(name = "Verbose", description = "Verbose output of WSI tools", type = SettingType.BOOLEAN)
    String VERBOSE = WSISettings.class.getSimpleName() + "@" + "verbose";
    ...
    */
    ...
    String PROFILE_TYPE = WSISettings.class.getSimpleName() + "@" + "profile_type";
    ...
    String CORRELATION_TYPE = WSISettings.class.getSimpleName() + "@" + "correlation_type";

    @Setting(name = "Message entry", description = "Message entries should be included in the report", type = SettingType.BOOLEAN)
    String MESSAGE_ENTRY = WSISettings.class.getSimpleName() + "@" + "messageEntry";
    ...
    String FAILURE_MESSAGE = WSISettings.class.getSimpleName() + "@" + "failureMessage";
    ...
    String ASSERTION_DESCRIPTION = WSISettings.class.getSimpleName() + "@" + "assertionDescription";
    ...
    String WSI_LOCATION = WSISettings.class.getSimpleName() + "@" + "location";

    @Setting(name = "Show log", description = "Show console-log for ws-i analyzer", type = SettingType.BOOLEAN)
    String SHOW_LOG = WSISettings.class.getSimpleName() + "@" + "showLog";
    ...
    String OUTPUT_FOLDER = WSISettings.class.getSimpleName() + "@" + "outputFolder";
}
