...
public interface HttpSettings {
    long DEFAULT_SOCKET_TIMEOUT = 60000L;

    String HTTP_VERSION_0_9 = "0.9";
    String HTTP_VERSION_1_0 = "1.0";
    String HTTP_VERSION_1_1 = "1.1";
    ...
    String HTTP_VERSION = HttpSettings.class.getSimpleName() + "@" + "http_version";

    @Setting(name = "User-Agent Header", description = "User-Agent HTTP header to send, blank will send default")
    String USER_AGENT = HttpSettings.class.getSimpleName() + "@" + "user-agent";
    ...
    String REQUEST_COMPRESSION = HttpSettings.class.getSimpleName() + "@" + "request-compression";

    @Setting(name = "Response compression", description = "Accept compressed responses from hosts", type = SettingType.BOOLEAN)
    String RESPONSE_COMPRESSION = HttpSettings.class.getSimpleName() + "@" + "response-compression";
    ...
    String DISABLE_RESPONSE_DECOMPRESSION = HttpSettings.class.getSimpleName()
    ...
    String CLOSE_CONNECTIONS = HttpSettings.class.getSimpleName() + "@" + "close-connections";
    ...
    String CHUNKING_THRESHOLD = HttpSettings.class.getSimpleName() + "@" + "chunking_threshold";
    ...
    String AUTHENTICATE_PREEMPTIVELY = HttpSettings.class.getSimpleName() + "@"
    ...
    String EXPECT_CONTINUE = HttpSettings.class.getSimpleName() + "@expect-continue";
    ...
    String ENCODED_URLS = HttpSettings.class.getSimpleName() + "@" + "encoded_urls";
    ...
    String FORWARD_SLASHES = HttpSettings.class.getSimpleName() + "@" + "forward_slashes";

    @Setting(name = "Bind Address", description = "Default local address to bind to when sending requests")
    String BIND_ADDRESS = HttpSettings.class.getSimpleName() + "@" + "bind_address";
    ...
    String INCLUDE_REQUEST_IN_TIME_TAKEN = HttpSettings.class.getSimpleName() + "@"
    ...
    String LEAVE_MOCKENGINE = HttpSettings.class.getSimpleName() + "@" + "leave_mockengine";

    @Setting(name = "Enable Mock HTTP Log", description = "Logs wire content of all mock requests", type = SettingType.BOOLEAN)
    String ENABLE_MOCK_WIRE_LOG = HttpSettings.class.getSimpleName() + "@" + "enable_mock_wire_log";

    @Setting(name = "Start REST MockService", description = "Start REST MockService after creation", type = SettingType.BOOLEAN)
    String START_MOCK_SERVICE = HttpSettings.class.getSimpleName() + "@" + "start_mock_service";
}
