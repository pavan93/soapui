...
public interface ProjectSettings {
    ...
    String PROJECT_ROOT = ProjectSettings.class.getSimpleName() + "@projectRoot";

    String PROJECT_NATURE = ProjectSettings.class.getSimpleName() + "@projectNature";

    @Setting(name = "Shadowing Password", description = "password for shadowing project password", type = SettingType.PASSWORD)
    String SHADOW_PASSWORD = ProjectSettings.class.getSimpleName() + "@" + "shadowPassword";

    @Setting(name = "Hermes Config", description = "hermes", type = SettingType.FOLDER)
    String HERMES_CONFIG = ProjectSettings.class.getSimpleName() + "@" + "hermesConfig";
