...
public interface WssContainerListener {
    void outgoingWssEntryAdded(WssEntry entry);

    void outgoingWssEntryRemoved(WssEntry entry);

    void outgoingWssEntryMoved(WssEntry entry, int offset);

    void cryptoAdded(WssCrypto crypto);

    void cryptoRemoved(WssCrypto crypto);

    void cryptoUpdated(WssCrypto crypto);
