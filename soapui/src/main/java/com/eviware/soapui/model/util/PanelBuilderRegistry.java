...
public class PanelBuilderRegistry {
    ...
    private static <T extends ModelItem> void register(Class<T> modelItemClass, PanelBuilder<T> panelBuilder) {
    ...
    private static void unregister(PanelBuilderFactory factory) {
